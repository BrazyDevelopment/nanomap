...
const calculateNodePositions = (): EcosystemData => {
    ...
    switch (categoryId) {
      ...
      case "faucets":
        return [
          ...
          { name: "Nanoriver Faucet", description: "Nano rewards every 20 minutes", url: "https://faucet.nanoriver.io", logo: "/logos/nanoriverfaucet.jpg", shape: "rectangle" },
        ]
      case "charity":
        return [
  ...
  const baseCategoryRadius = Math.max(0.8, 0.4 + totalNodes * 0.02)
